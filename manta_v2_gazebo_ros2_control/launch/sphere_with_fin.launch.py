...
def generate_launch_description():
    ...
    robot_name_in_model = 'floating_sphere_with_fin'
    # urdf_file_path = 'urdf/manta_v2_geometric_buoyancy.urdf'
    # urdf_file_path = 'urdf/stl_model.urdf'
    urdf_file_path = 'urdf/floating_sphere_with_fin.urdf'
    # world_file_path = 'worlds/underwater.world'    
