...
の4つの設定ができます。
Rviz, Rviz2ではDefaultでDisplaysとViewsが表示され、headerのPanelsボタンからチェックを入れると、他のパネルも使用することができます。
...
Classのrviz_default_pluginsは
Classのjsk_rviz_plugin/Plotter2D

ViewsのDistance, Yaw, PitchでどこからのViewにするかを決めれる
